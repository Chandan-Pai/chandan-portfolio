...
const AI_PHASES = [
  {
    ...
    ai: 'Helped turn the framing into Streamlit page structure and README drafts I edited hard.',
  },
  {
  ...
  },
  {
    ...
    mine: 'Moved filters to the top, forced human axis labels, and severity-style decisions — the readout posture I’d use with design and engineering partners.',
    ai: 'Iterated layout bugs (page navigation, clipping, Cloud multipage). AI accelerated fixes; judgment on what “good validation UI” means stayed mine.',
  },
];
      ...
      <header className="w-full bg-gradient-to-b from-slate-950 via-blue-950 to-slate-900 text-white pt-[max(5.5rem,env(safe-area-inset-top)+3rem)] pb-16 sm:pb-20 md:pt-32 md:pb-24">
        <MotionHero className="project-gutter-x w-full min-w-0">
          ...
          <FadeUp as="p" className="text-lg sm:text-xl text-gray-200 leading-relaxed mb-6 max-w-3xl">
            A product-focused study of how quantitative UX should land with partners: not a methods gallery —
            a repeatable motion from messy data to a ship / fix / watch decision.
          </FadeUp>
          <FadeUp as="p" className="text-sm text-sky-200/90 mb-8 max-w-3xl leading-relaxed border-l-2 border-sky-500/60 pl-4">
            Three study modes share one readout grammar — decision → KPIs → breaks → segments → method —
            so validation stays transferable across survey, usability, and A/B work.
          </FadeUp>
      ...
      <section className="project-gutter-x py-10 sm:py-14 border-b border-slate-800">
        <div className="max-w-5xl mx-auto">
          ...
          <FadeUp as="p" className="text-slate-400 text-sm mb-2 max-w-3xl leading-relaxed">
            Interactive suite with Survey, Usability, and A/B pages. Filters sit at the top of each study;
            each page leads with a decision, then KPIs and breaks.
          </FadeUp>
          <LiveSiteEmbed
            url={LIVE_URL}
        ...
        <div className="mx-auto max-w-5xl space-y-14">
          <MotionBlock>
            ...
            <FadeUp as="p" className="text-slate-300 leading-relaxed mb-4">
              ...
              and what to change next. The failure mode is a methods collage that never influences a product call.
            </FadeUp>
            <FadeUp as="p" className="text-slate-300 leading-relaxed">
              <strong className="text-slate-100">Hypothesis:</strong> a shared readout grammar across survey,
              usability, and A/B makes validation transferable — the same way a real research ops motion would.
            </FadeUp>
          </MotionBlock>
          ...
          <MotionBlock>
            ...
            <FadeUp as="ul" className="space-y-4 text-slate-300 leading-relaxed">
              <li>
                ...
                each have a direction of “better.” Completion alone is incomplete evidence.
              </li>
              <li>
...
{`raw educational CSV
  ...
  → Community Cloud redeploy on git push`}
            ...
            <FadeUp as="p" className="text-slate-300 leading-relaxed">
              ...
              new study type can follow the same pattern.
            </FadeUp>
          </MotionBlock>
          ...
          <MotionBlock>
            ...
            <FadeUp as="p" className="text-slate-300 leading-relaxed mb-6">
              AI accelerated implementation; research framing, honesty locks, and partner language stayed mine.
            </FadeUp>

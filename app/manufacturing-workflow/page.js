            ...
            <div className="bg-slate-900/50 p-8 rounded-lg border border-slate-700">
              ...
              <ul className="space-y-3 text-slate-300">
                <li className="flex items-start gap-3">
                  <span className="text-slate-100 font-bold mt-1">→</span>
              ...
              <div className="grid md:grid-cols-2 gap-12 items-center">
                <div>
                  ...
                  <div className="p-4 bg-slate-900 border border-slate-700 rounded">
                    <p className="text-xs text-slate-400 font-mono">Shift: 415 min/shift × 3 shifts/day × 22 days = 27,390 min/month</p>
                    <p className="text-xs text-slate-400 font-mono">Demand: 122,000 blades/month</p>
                ...
                <div className="bg-slate-900 p-8 rounded-lg border border-slate-700">
                  ...
                  <div className="space-y-3 text-sm text-slate-400">
                    <div className="p-3 bg-slate-900/50 rounded">
                      <p className="font-semibold text-slate-100">10mm Blades</p>
                      <p>7 cycles × 160 blades = 1,120 blades</p>
                    </div>
                    <div className="p-3 bg-slate-900/50 rounded">
                      <p className="font-semibold text-slate-100">15mm Blades</p>
                ...
                <div className="bg-slate-900 p-8 rounded-lg border border-slate-700 order-2 md:order-1">
                  ...
                  <div className="space-y-2 text-sm">
                    <div className="flex justify-between items-center p-2 bg-slate-800/80 rounded border border-slate-600">
                      <span className="text-slate-300">Station 5: Blade Break</span>
                    ...
                    <div className="flex justify-between items-center p-2 bg-slate-900/50 rounded">
                      <span className="text-slate-300">Station 6: Degreasing</span>
                      <span className="font-bold">12.1s</span>
                    </div>
                    <div className="flex justify-between items-center p-2 bg-slate-900/50 rounded">
                      <span className="text-slate-300">Station 7: Inspection</span>
                    ...
                    <div className="flex justify-between items-center p-2 bg-sky-950/50 rounded border border-sky-700/50 mt-3">
                      <span className="text-slate-300"><strong>Takt Time Target</strong></span>

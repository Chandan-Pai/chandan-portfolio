    ...
    <main className="min-h-screen bg-white text-slate-900 antialiased">
      ...
      <section className="max-w-6xl mx-auto px-6 py-20">
        ...
        <div className="grid grid-cols-2 gap-6">
          ...
          <img src="/Images/Repair manual/AEIOU Field observations.png" alt="AEIOU Field Observation" className="w-full rounded-xl border border-slate-200 mb-16" />
          <img src="/Images/Repair manual/Observation sheets.png" alt="Observation sheets" className="w-full rounded-xl border border-slate-200 mt-8" />
        </div>
      ...
      <section className="w-full bg-slate-50 border-y border-slate-200 py-20 px-6">
        <div className="max-w-6xl mx-auto">
          ...
          <img src="/images/repair manual/Journey Map.png" alt="Journey Map" className="w-full rounded-xl border border-slate-200 mt-8" />
          <img src="/images/repair manual/Affinity Diagraming.png" alt="Affinity Diagram" className="w-full rounded-xl border border-slate-200 mt-6" />    
        </div>
      </section>
      ...
      <section className="max-w-6xl mx-auto px-6 py-20">
        ...
        <div className="mb-12">
          ...
          <div className="rounded-xl overflow-hidden border border-slate-200 max-w-2xl">
            <img src="/images/repair manual/Pig drawing reference.png" alt="Correct pig drawing reference" className="w-full h-auto" />
        ...
        <div className="grid grid-cols-2 gap-6 mb-12">
          <div className="rounded-xl overflow-hidden border border-slate-200">
            <img src="/images/repair manual/Pig drawing test text.jpg" alt="Text-only pig instructions" className="w-full h-auto" />
            <div className="bg-red-50 p-3">
              <p className="text-xs font-semibold text-red-700">Text-only instructions — chaotic results</p>
            </div>
          </div>
          <div className="rounded-xl overflow-hidden border border-slate-200">
            <img src="/images/repair manual/Pig drawing test visual.jpg" alt="Visual-guided pig drawings" className="w-full h-auto" />
      ...
      <section className="w-full bg-slate-900 py-20 px-6">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-2 gap-6 mt-8">
            <img src="/images/repair manual/Age Group Distribution.jpg" alt="Age group distribution" className="w-full rounded-xl border border-slate-200" />
            <img src="/images/repair manual/Top Frustrations.jpg" alt="Top frustrations" className="w-full rounded-xl border border-slate-200" />
            <img src="/images/repair manual/where are manuals used.png" alt="Where manuals are used" className="w-full rounded-xl border border-slate-200" />
          </div>
        </div>
      </section>
